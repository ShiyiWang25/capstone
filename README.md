...
This project is composed of one README file, two data folder, one markdown (report_r.Rmd), one ipython notebook (report_python.ipynb), one [figure](https://github.com/ShiyiWang25/capstone/tree/main/figure) folder storing the figures and tables generated. 
